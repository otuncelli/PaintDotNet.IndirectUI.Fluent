...
public static class PropertyControlInfoExtensions
{
    private static PropertyControlInfo SetPropertyControlValue(this PropertyControlInfo pci, ControlInfoPropertyNames controlPropertyName, object controlPropertyValue)
    {
        ...
        Property property = pci.ControlProperties[controlPropertyName] 
            ?? throw new ArgumentException($"Cannot find property with name `{controlPropertyName}`", nameof(controlPropertyName));
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.AllowAllFiles, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.ButtonText, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.ControlColors, values);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.ControlStyle, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.DecimalPlaces, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.Description, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.DisplayName, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.FileTypes, values);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.Footnote, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.Multiline, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.RangeWraps, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.ShowResetButton, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderLargeChange, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderLargeChangeX, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderLargeChangeY, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderLargeChangeZ, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderShowTickMarks, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderShowTickMarksX, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderShowTickMarksY, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderShowTickMarksZ, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderSmallChange, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderSmallChangeX, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderSmallChangeY, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.SliderSmallChangeZ, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.StaticImageUnderlay, value);
    }
    ...
    {
        return pci.StaticImageUnderlay(Convert.FromBase64String(base64string));
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.UpDownIncrement, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.UpDownIncrementX, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.UpDownIncrementY, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.UpDownIncrementZ, value);
    }
    ...
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.UseExponentialScale, value);
    }

    public static PropertyControlInfo WindowHelpContent(this PropertyControlInfo pci, string value)
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.WindowHelpContent, value);
    }

    public static PropertyControlInfo WindowHelpContentType(this PropertyControlInfo pci, WindowHelpContentType value)
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.WindowHelpContentType, value);
    }

    public static PropertyControlInfo WindowIsSizable(this PropertyControlInfo pci, bool value = true)
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.WindowIsSizable, value);
    }

    public static PropertyControlInfo WindowTitle(this PropertyControlInfo pci, string value)
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.WindowTitle, value);
    }

    public static PropertyControlInfo WindowWidthScale(this PropertyControlInfo pci, double value)
    {
        return pci.SetPropertyControlValue(ControlInfoPropertyNames.WindowWidthScale, value);
    }
    ...
    {
        return pci.ValueDisplayName((object)value, displayName);
    }
    ...
    {
        return pci.ValueDisplayNameCallback(o => displayNameGetter((T)o));
    }
    ...
    public static PropertyControlInfo ValueDisplayNameCallback(this PropertyControlInfo pci, Func<object, string> displayNameGetter)
    {
        ...
        {
            throw new ArgumentException($"Property must be an instance of `{nameof(StaticListChoiceProperty)}`", nameof(pci));
        }
    ...
    public static PropertyControlInfo ControlType(this PropertyControlInfo pci, PropertyControlType newControlType)
    {
        ...
        {
            throw new ArgumentException($"Cannot set control type of `{newControlType}` for property `{pci.Property.Name}`", nameof(newControlType));
        }
    ...
    public static PropertyControlInfo Panel(this PropertyControlInfo pci, PanelControlInfo panel)
    {
        _ = panel.AddChildControl(pci);
        return pci;
    }

    public static PropertyControlInfo TabPage(this PropertyControlInfo pci, TabPageControlInfo tab)
    {
        _ = tab.AddChildControl(pci);
        return pci;
    }
}
